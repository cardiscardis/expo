...
private fun injectLocalBundleLoader(
  ...
  return try {
    ...
    val jsBundleLoaderProperty = reactHostDelegate::jsBundleLoader.apply { isAccessible = true }
    val jsBundleLoaderField = jsBundleLoaderProperty.javaField!!
    jsBundleLoaderField.isAccessible = true
    jsBundleLoaderField.set(reactHostDelegate, newJsBundleLoader)
